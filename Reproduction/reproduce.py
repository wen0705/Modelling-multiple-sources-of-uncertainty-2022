...
test_dataset = torch.utils.data.ConcatDataset([test_indomain,test_OOD])
...
for batch, (data, label) in enumerate(test_loader):
  ...
  # differential.append(list(dff_score[label>9]))
  # datauncertainty.append(list(data_score[label>9]))
  entropy.append(list(ent_score[new_label]))
  differential.append(list(dff_score[new_label]))
  datauncertainty.append(list(data_score[new_label]))
  MI.append(list(MI_score[new_label]))
